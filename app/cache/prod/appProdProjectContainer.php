...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Odm_Mongodb_DefaultConfigurationService()
    {
        ...
        $a->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('doctrine.odm.mongodb.metadata.annotation_reader'), array(0 => '/home/lelo/projects/symfony.dev/src/Sensio/HelloBundle/Document')), 'Sensio\\HelloBundle\\Document');
        ...
        $instance->setProxyDir('/home/lelo/projects/symfony.dev/app/cache/prod/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('Proxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('/home/lelo/projects/symfony.dev/app/cache/prod/doctrine/odm/mongodb/Hydrators');
    ...
    {
        return $this->services['doctrine.odm.mongodb.logger'] = new \Symfony\Bundle\DoctrineMongoDBBundle\Logger\DoctrineMongoDBLogger(NULL);
    }
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/home/lelo/projects/symfony.dev/app/cache/prod', 'appprodUrlMatcher', 'appprodUrlGenerator');
    }
    protected function getRouter_RealService()
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/home/lelo/projects/symfony.dev/app/config/routing.yml', array('cache_dir' => '/home/lelo/projects/symfony.dev/app/cache/prod', 'debug' => false, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appprodUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appprodUrlMatcher', 'resource_type' => ''));
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/home/lelo/projects/symfony.dev/app/cache/prod/translations', 'debug' => false), $this->get('session'));
        $instance->setFallbackLocale('en');
        return $instance;
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => '/home/lelo/projects/symfony.dev/app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/lelo/projects/symfony.dev/app/cache/prod',
            ...
            'routing.resource' => '/home/lelo/projects/symfony.dev/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/lelo/projects/symfony.dev/app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.odm.mongodb.proxy_dir' => '/home/lelo/projects/symfony.dev/app/cache/prod/doctrine/odm/mongodb/Proxies',
            'doctrine.odm.mongodb.auto_generate_proxy_classes' => false,
            'doctrine.odm.mongodb.hydrator_namespace' => 'Hydrators',
            'doctrine.odm.mongodb.hydrator_dir' => '/home/lelo/projects/symfony.dev/app/cache/prod/doctrine/odm/mongodb/Hydrators',
