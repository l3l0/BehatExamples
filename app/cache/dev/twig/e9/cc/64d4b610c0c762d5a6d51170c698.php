...
class __TwigTemplate_e9cc64d4b610c0c762d5a6d51170c698 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context['name'] => $context['template']) {
            // line 25
            echo "    ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'template', '25'), "renderblock", array("toolbar", array("collector" => $this->getAttribute($this->getContext($context, 'profiler', '25'), "get", array($this->getContext($context, 'name', '25'), ), "method", false, 25), "profiler_url" => $this->getContext($context, 'profiler_url', '25')), ), "method", false, 25), "html");
            echo "
";
        }
